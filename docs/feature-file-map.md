...
| F-02 | Grammar Topic Intro + voice controls | Partial-High | `app/screen3-grammar-topic-intro/page.js`, `src/ui/stitch/screen3-grammar-topic-intro.html` | Next.js route implements anchored intro composition, shared header, dynamic aspect-card rendering, loading/error/content states, and single speaker on/off voice control. |
