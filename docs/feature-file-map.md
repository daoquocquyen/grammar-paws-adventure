...
| F-01 | World Map / Topic Selection | Partial-High | `app/screen2-world-map-topic-selection/page.js`, `src/lib/playerLevel.js`, `src/ui/stitch/screen2-world-map-topic-selection.html` | React route includes profile hydration, intro-first start-topic routing, scaled card UI, and progress-derived level badge; static topic dataset remains. |
