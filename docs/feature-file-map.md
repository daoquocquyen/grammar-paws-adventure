...
- [ ] Migrate Screen 2 behavior from `src/ui/stitch` into `app/world-map/page.js` (currently re-exporting `app/screen2-world-map-topic-selection/page.js`).
