...
const QUESTION_BLUEPRINTS = {
    ...
    "verbs::present-simple": {
        prompt: "Verbs: choose the simple present form.",
        hint: "Simple present is used for habits and routines.",
        correctFeedback: "Correct. That verb form fits a regular action.",
        incorrectFeedback: "Pick the verb form used for everyday habits.",
        sentenceFrames: [
            { before: "Every morning, I", after: "my bag." },
            { before: "He", after: "to school by bus." },
            { before: "They", after: "football after class." },
            { before: "She", after: "her homework after dinner." },
            { before: "We", after: "English on Mondays." },
            { before: "My brother", after: "milk at breakfast." },
        ],
        correctPool: ["pack", "goes", "play", "does", "study", "drinks"],
        distractorPool: ["packed", "going", "plays", "doing", "studied", "drink"],
    },
    "verbs::time-marker": {
    ...
    "prepositions::position": {
        prompt: "Prepositions: choose the position word.",
        hint: "Position prepositions show where one thing is relative to another.",
        correctFeedback: "Correct. That preposition shows position.",
        incorrectFeedback: "Pick the preposition that tells relative position.",
        sentenceFrames: [
            { before: "The cat is", after: "the two chairs." },
            { before: "The bag is", after: "my desk and my chair." },
            { before: "The ball rolled", after: "the table legs." },
        ],
        correctPool: ["between", "between", "between", "near", "beside", "next to"],
        distractorPool: ["during", "because", "quickly", "tomorrow", "and", "or"],
    },
    "prepositions::relation": {
        prompt: "Prepositions: choose the relative place phrase.",
        hint: "Relative place phrases describe exact location.",
        correctFeedback: "Great. That phrase shows where something is.",
        incorrectFeedback: "Pick the phrase that best shows location.",
        sentenceFrames: [
            { before: "The lamp is", after: "the sofa." },
            { before: "The bike is parked", after: "the garage." },
            { before: "The shoes are", after: "the door." },
        ],
        correctPool: ["in front of", "next to", "behind", "under", "near", "beside"],
        distractorPool: ["during", "because", "quickly", "and", "or", "tomorrow"],
    },
    "prepositions::time": {
    ...
    "tenses::present-continuous": {
        prompt: "Tenses: choose the present continuous form.",
        hint: "Use present continuous for actions happening now.",
        correctFeedback: "Correct. That shows an action happening right now.",
        incorrectFeedback: "Pick the form with am/is/are + -ing for now.",
        sentenceFrames: [
            { before: "Right now, they", after: "in the yard." },
            { before: "Look! She", after: "a picture." },
            { before: "At the moment, we", after: "grammar together." },
        ],
        correctPool: ["are playing", "is drawing", "are studying", "am reading", "is running", "are singing"],
        distractorPool: ["play", "draws", "study", "read", "runs", "sing"],
    },
    "tenses::simple-present": {
        prompt: "Tenses: choose the simple present form.",
        hint: "Use simple present for routines and repeated actions.",
        correctFeedback: "Correct. That verb form describes a regular habit.",
        incorrectFeedback: "Pick the verb form used for everyday routines.",
        sentenceFrames: [
            { before: "Every day, they", after: "at 7 a.m." },
            { before: "She usually", after: "her room on Saturday." },
            { before: "I always", after: "my homework after dinner." },
        ],
        correctPool: ["wake up", "cleans", "finish", "walk", "reads", "eat"],
        distractorPool: ["are waking up", "is cleaning", "am finishing", "walking", "is reading", "are eating"],
    },
    "tenses::present": {
